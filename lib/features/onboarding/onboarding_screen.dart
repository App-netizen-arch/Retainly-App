...
class _OnboardingScreenState extends ConsumerState<OnboardingScreen> {
      ...
      children: [
        ...
        Align(
          ...
          child: ElevatedButton(
            onPressed:
                _academicGroup != null ? () => setState(() => _step = 1) : null,
      ...
      children: [
        ...
        Row(
          children: [
            ...
            ElevatedButton(
              onPressed:
                  _religion != null ? () => setState(() => _step = 2) : null,
              child: const Text('Next'),
            ),
          ],
        ),
              ...
              electives
                  .map(
                    (subject) => ChoiceChip(
                      ...
                      tooltip: 'Select${_selectedElectives.contains(subject['name']) ? 'ed' : ''} elective: ${subject['name']}',
                      onSelected: (selected) {
                        setState(() {
                          if (selected) {
  ...
  Widget _buildSubjectSummary() {
    ...
    final List<Map<String, String>> compulsoryWithReligion = List.from(
      MatricSubjects.compulsorySubjects,
    );
      ...
      children: [
        ...
        ElevatedButton(
          onPressed:
              _isLoading
                  ? null
                  : () => _saveSubjectSelection(
                    compulsoryWithReligion,
                    selectedElectives,
                    context,
                  ),
          child:
